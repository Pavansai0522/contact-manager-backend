...
@CrossOrigin(origins = "https://contact-manager-frontend-git-b8e1c2-pavansais-projects-2abe6514.vercel.app")
@RestController
...
public class ContactController {
    ...
    public ResponseEntity<String> createContact(@RequestBody Contact contact) {
        System.out.println("Received new contact: " + contact.getFirstName() + " " + contact.getLastName());
        return ResponseEntity.ok("Contact created (simulated)");
    }
}
